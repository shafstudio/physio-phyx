    ...
    <section className="py-24 bg-background-light" id="help">
      <div className="container mx-auto px-6 md:px-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          <div>
            <h4 className="text-primary font-bold uppercase tracking-widest text-sm mb-3">Conditions We Treat</h4>
            <h2 className="text-3xl md:text-4xl font-bold text-[#1c140d]">How We Can Help</h2>
          </div>
          <a className="hidden md:flex items-center gap-2 text-sm font-bold text-[#1c140d] border-b-2 border-transparent hover:border-primary pb-1 transition-all" href="#contact">
            Consult With Us <span className="material-symbols-outlined text-sm">arrow_forward</span>
          </a>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[600px]">
          <Link href="/services/sports-injury-acl" className="md:col-span-6 lg:col-span-5 relative group overflow-hidden h-96 md:h-full block">
            <Image
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent p-8 flex flex-col justify-end">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">Sports Injury &amp; ACL</h3>
              <p className="text-gray-300 text-sm leading-relaxed max-w-sm">
                Comprehensive rehabilitation protocols to guide you from surgery back to high-impact sports confidently.
              </p>
            </div>
          </Link>
          <div className="md:col-span-6 lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Link href="/services/geriatric-mobility" className="bg-white p-8 flex flex-col justify-between border border-gray-100 hover:border-primary/30 transition-colors group h-full">
              <div>
                ...
                <h3 className="text-lg font-bold text-[#1c140d] mb-2">Geriatric Mobility</h3>
                <p className="text-gray-500 text-xs leading-relaxed">
                  Programs focused on balance, fall prevention, and maintaining independence.
                </p>
              </div>
            ...
            <div className="bg-white p-8 flex flex-col justify-between border border-gray-100 hover:border-primary/30 transition-colors group h-full">
              <div>
                ...
                <h3 className="text-lg font-bold text-[#1c140d] mb-2">Chronic Back Pain</h3>
                <p className="text-gray-500 text-xs leading-relaxed">
                  Evidence-based strategies to reduce pain intensity and prevent recurrence.
                </p>
              </div>
              <div className="relative w-full h-32 mt-6">
                <Image
            ...
            <div className="sm:col-span-2 bg-[#1c140d] p-8 flex flex-row items-center gap-6 group relative overflow-hidden">
              ...
              <div className="relative z-10 w-full flex justify-between items-center">
                <div>
                  <h3 className="text-xl font-bold text-white mb-1">Shoulder Rehab</h3>
                  <p className="text-gray-400 text-xs">Rotator cuff therapies to restore full range.</p>
                </div>
